...
public class DefaultAnimationSet extends AnimationMapWrapper {
    ...
    @Override
    public TextureRegion play(Entity e, float time) {
        return animations.get(e.getDirection()).getKeyFrame(time, true);
    }
}
