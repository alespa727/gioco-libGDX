package progetto.entity.specific.base;
...
import progetto.entity.animations.AnimationSetMap;
import progetto.entity.animations.DefaultAnimationSet;
import progetto.entity.components.base.Component;
import progetto.entity.components.base.IteratableComponent;
import progetto.entity.components.specific.entity.DirectionComponent;
import progetto.entity.components.specific.entity.NodeTrackerComponent;
import progetto.entity.components.specific.entity.PhysicsComponent;
import progetto.entity.components.specific.entity.StateComponent;
...
public abstract class Entity {
    ...
    private final AnimationSetMap textures;       // Gestisce immagini e animazioni
    String[] animations_names={
        "default"
    };
    ...
    public Entity(EntityInstance instance, EntityManager manager) {
        ...
        Texture[] animations = new Texture[1];
        animations[0] = config.img;
        this.textures = new AnimationSetMap(animations_names, animations);
     ...
     */
    public AnimationSetMap getTextures() {
        return textures;
    }
