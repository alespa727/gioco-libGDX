...
public class Dialog extends RectangleMapEvent {
    ...
    public Dialog(Vector2 position, float width, float height, String text, float delay, float length, GameScreen game) {
